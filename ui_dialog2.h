...
public:
    ...
    {
        Dialog->setWindowTitle(QCoreApplication::translate("Dialog", "Server", nullptr));
        pbStartStop->setText(QCoreApplication::translate("Dialog", "Stop server", nullptr));
        leHost->setText(QCoreApplication::translate("Dialog", "0.0.0.0", nullptr));
